...
describe("deck head under a base path", () => {
  ...
  // (published:false) and `hidden` (unlisted:true). A production build must emit the first and drop the
  ...
  it("builds an unlisted:true deck but marks it noindex and pagefind-ignored", async () => {
